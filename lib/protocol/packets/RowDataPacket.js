...
RowDataPacket.prototype._typeCast = function(field, parser) {
  switch (field.type) {
    ...
    case Types.NEWDATE:
      ...
      // Added Z to end of dateString to force using UTC time for database, as this works for our purposes (jpravetz)
      // Otherwise dateString is always evaluated at process' localtime.
      // The proposed workaround of setting process tz to localtime is not acceptable as
      // the process may be interfacing with multiple databases in different timezones.
